...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .btn { display: block; width: 100%; padding: 15px; border-radius: 15px; text-decoration: none; text-align: center; font-weight: 800; border: none; cursor: pointer; font-family: 'Outfit'; }
    .btn-primary { background: white; color: black; }
    input, select { width: 100%; padding: 12px; margin-bottom: 10px; border-radius: 12px; border: 1px solid var(--border); background: rgba(0,0,0,0.5); color: white; }
</style>
"""
...
<div class="container">
    <header style="text-align: center; padding: 40px 0;">
        <h1 style="font-family: 'Outfit'; font-size: 40px; letter-spacing: -2px;">JUMUSH BAR</h1>
        <p style="color: #999; font-size: 13px; margin-top: 5px;">Жумуш издөө порталы</p>
    ...
    <div class="glass-card">
        ...
        <a href="https://wa.me/{{ job.wa }}" style="color: var(--neon); text-decoration: none; display: block; margin-top: 15px; border-top: 1px solid var(--border); padding-top: 10px;">WhatsApp аркылуу байланышуу →</a>
    </div>
    {% endfor %}
</div>
"""
...
<div class="container">
    <div class="glass-card" style="margin-top: 50px;">
        <h2 style="text-align: center; margin-bottom: 25px; font-family: 'Outfit';">Жаңы жарыя</h2>
        <form method="POST">
            ...
            <a href="{{ url_for('index') }}" style="display:block; text-align:center; margin-top:15px; color:#999; text-decoration:none; font-size: 14px;">← Артка кайтуу</a>
        </form>
    </div>
</div>
"""
